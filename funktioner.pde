...
Legeme legemeFromJSON(JSONObject legemeJSON) {
  Legeme legeme = new Legeme(legemeJSON.getString("navn"), legemeJSON.getDouble("x"), legemeJSON.getDouble("y"), legemeJSON.getDouble("radius"), legemeJSON.getDouble("masse"), color(legemeJSON.getJSONObject("farve").getInt("r"), legemeJSON.getJSONObject("farve").getInt("g"), legemeJSON.getJSONObject("farve").getInt("b")));
  return legeme;
}
